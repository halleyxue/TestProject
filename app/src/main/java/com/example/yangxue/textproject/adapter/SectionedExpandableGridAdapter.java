...
public class SectionedExpandableGridAdapter extends RecyclerView.Adapter<SectionedExpandableGridAdapter.ViewHolder> {
    ...
    //view type
    private static final int VIEW_TYPE_SECTION = R.layout.section_header;
    private static final int VIEW_TYPE_ITEM = R.layout.section_item; //TODO : change this
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                itemTextView = (TextView) view.findViewById(R.id.tvItem);
            } else {
                sectionTextView = (TextView) view.findViewById(R.id.tvTitle);
                sectionToggleButton = (ToggleButton) view.findViewById(R.id.imgArrow);
            }
        }
    }
}
